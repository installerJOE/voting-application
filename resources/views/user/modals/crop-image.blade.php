  ...
  <div class="modal-dialog modal-lg" role="document">
      <div class="modal-content">
          ...
          <div class="modal-footer ctrl-btn">
                <button type="button" class="btn btn-alert-modal btn-blue-bg" id="cropImage" onclick="closeImageCropperModal()">
                    Crop
                </button>
                <button type="button" class="btn btn-alert-modal btn-blue-bd" data-bs-dismiss="modal">
                    Cancel
                </button>
          </div>
      </div>
